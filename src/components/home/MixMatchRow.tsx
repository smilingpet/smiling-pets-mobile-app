      ...
      <div className="scrollbar-none -mx-4 flex gap-3 overflow-x-auto px-4 pb-1">
        {MIX_AND_MATCH.map((item) => (
          <Link
            ...
            className="group flex w-32 shrink-0 flex-col items-center gap-2.5 rounded-2xl border border-surface-border bg-gradient-to-b from-brand-50 to-white p-4 text-center shadow-card transition active:scale-95"
          >
